...
/***/ function(module, exports, __webpack_require__) {
	...
	var queries = [];
	queries.push('CREATE TABLE user_credentials ( ' + 'email text,' + 'password text,' + 'userid uuid,' + 'PRIMARY KEY (email));');
	queries.push('CREATE TABLE user_credentials ( ' + 'email text,' + 'password text,' + 'userid uuid,' + 'PRIMARY KEY (email));');
	
	__webpack_require__(27)(queries, client);
	//test
...
//# sourceMappingURL=0.16ea886a8c0f4b7e6847.hot-update.js.map