...
/***/ function(module, exports, __webpack_require__) {
	...
	var queries = [];
	quries.push('CREATE TABLE user_credentials ( ' + 'email text,' + 'password text,' + 'userid uuid,' + 'PRIMARY KEY (email)');
	quries.push('CREATE TABLE user_credentials ( ' + 'email text,' + 'password text,' + 'userid uuid,' + 'PRIMARY KEY (email)');
	
	__webpack_require__(26)(quries, client);
	//test
...
//# sourceMappingURL=0.35478c08d17175b25bff.hot-update.js.map