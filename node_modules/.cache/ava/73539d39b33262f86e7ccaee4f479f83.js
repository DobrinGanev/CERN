...
const Foo = ({ children }) => React.createElement(
    'div',
    { className: 'Foo' },
    React.createElement(
        'h2',
...
test('has a .Foo class name', t => {
    ...
    const wrapper = shallow(React.createElement(Foo, null));
    t.true(_rec._expr(_rec._capt(_rec._capt(wrapper, 'arguments/0/callee/object').hasClass('Foo'), 'arguments/0'), {
        content: 't.true(wrapper.hasClass(\'Foo\'))',
        filepath: 'src/components/__tests__/Foo.spec.js',
        line: 15,
        ast: '{"type":"CallExpression","callee":{"type":"MemberExpression","object":{"type":"Identifier","name":"t","range":[0,1]},"property":{"type":"Identifier","name":"true","range":[2,6]},"computed":false,"range":[0,6]},"arguments":[{"type":"CallExpression","callee":{"type":"MemberExpression","object":{"type":"Identifier","name":"wrapper","range":[7,14]},"property":{"type":"Identifier","name":"hasClass","range":[15,23]},"computed":false,"range":[7,23]},"arguments":[{"type":"StringLiteral","value":"Foo","range":[24,29]}],"range":[7,30]}],"range":[0,31]}',
        tokens: '[{"type":{"label":"name"},"value":"t","range":[0,1]},{"type":{"label":"."},"range":[1,2]},{"type":{"label":"true"},"value":"true","range":[2,6]},{"type":{"label":"("},"range":[6,7]},{"type":{"label":"name"},"value":"wrapper","range":[7,14]},{"type":{"label":"."},"range":[14,15]},{"type":{"label":"name"},"value":"hasClass","range":[15,23]},{"type":{"label":"("},"range":[23,24]},{"type":{"label":"string"},"value":"Foo","range":[24,29]},{"type":{"label":")"},"range":[29,30]},{"type":{"label":")"},"range":[30,31]}]',
        visitorKeys: _powerAssertVisitorKeys
    }));
});
//# sourceMappingURL=../../../node_modules/.cache/ava/73539d39b33262f86e7ccaee4f479f83.js.map