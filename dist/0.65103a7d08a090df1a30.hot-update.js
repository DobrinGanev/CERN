...
/***/ function(module, exports, __webpack_require__) {
	...
	'CREATE TABLE tags_by_letter (' + 'first_letter text,' + 'tag text,' + 'PRIMARY KEY (first_letter, tag));',
	...
	'CREATE TABLE video_event (' + 'videoid uuid,' + 'userid uuid,' + 'event varchar,' + 'event_timestamp timeuuid,' + 'video_timestamp bigint,' + 'PRIMARY KEY ((videoid,userid),event_timestamp,event)' + ') WITH CLUSTERING ORDER BY (event_timestamp DESC,event ASC);'];
	
	var async = __webpack_require__(28);
	module.exports = function (client) {
	
	  async.each(tables, function (query, callback) {
	    console.log(query);
...
//# sourceMappingURL=0.65103a7d08a090df1a30.hot-update.js.map